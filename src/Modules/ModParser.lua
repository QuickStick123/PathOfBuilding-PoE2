...
local modFlagList = {
	...
	["with quarterstaves"] = { flags = bor(ModFlag.Quarterstaff, ModFlag.Hit) },
	["to quarterstaff attacks"] = { flags = bor(ModFlag.Quarterstaff, ModFlag.Hit) },
	["with quarterstaff attacks"] = { flags = bor(ModFlag.Quarterstaff, ModFlag.Hit) },
